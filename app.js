    ...
    if ( !user ) {
      ...
      user.save(function( err ) {
        if ( err ) {
          ...
          var subject = 'Finalsclub.org Activation';
          var body = 'A user at Finalsclub.org input your email as the instructor of Course: '+course.name+'\n\nPlease goto Finalsclub.org and login with your email and the autogenerated password: '+password+'\n\nAfter logging in you will need to activate your account. Please enter this code when prompted\n\n'+user.activateCode;
          email(user.email, {subject: subject, body: body});
...
app.post( '/register', function( req, res ) {
  ...
  user.activateCode = hat(64);
    ...
    var subject = 'Finalsclub.org Activation';
    var body = 'Thank you for registering at Finalsclub.org\n\nTo activate your account please enter this code when prompted\n\n'+user.activateCode;
    email(user.email, {subject: subject, body: body});
